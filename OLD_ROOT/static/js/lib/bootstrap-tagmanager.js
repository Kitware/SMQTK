...
(function($){
  ...
  $.fn.tagsManager = function (options,tagToManipulate, clsname) {
    ...
    var pushTag = function (tag, clsname) {
        clsname = clsname || "";
        tag = trimTag(tag);
      ...
      if (alreadyInList) {
        ...
        var html = '<span class="' + tagClasses() + " " + clsname +  '" id="' + newTagId + '">';
      ...
      if (typeof options == 'string') {
        ...
        switch (options) {
          ...
          case "popTag":
            ...
            break;
          case "pushTag":
            pushTag(tagToManipulate, clsname);
            break;
        }
        return;
      }

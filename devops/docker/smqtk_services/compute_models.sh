...
FLANN_LOG=/logs/train.flann.log
NNSS_CONFIG=/app/configs/nnss.config.json
...
echo "#####################"
echo "# Build FLANN index #"
echo "#####################"
# Steal parameters from NNSS config
python -c "
import logging, json

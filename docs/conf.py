# -*- coding: utf-8 -*-
#
# SMQTK documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'SMQTK.tex', u'SMQTK Documentation',
...
man_pages = [
    (master_doc, 'smqtk', u'SMQTK Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SMQTK', u'SMQTK Documentation',
   author, 'SMQTK', 'One line description of project.',
   'Miscellaneous'),
]

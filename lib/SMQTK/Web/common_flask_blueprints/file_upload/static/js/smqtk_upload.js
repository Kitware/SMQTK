...
function FlowUploadZone(container, upload_url) {
    ...
    flow.on("fileSuccess", function (file, message) {
        ...
        hook_fileSuccess && hook_fileSuccess(file.uniqueIdentifier);
    });
     ...
     *
     * @param func Function taking one argument that is the file unique ID that
     *      is associated with the uploaded file's path server-side.
     */

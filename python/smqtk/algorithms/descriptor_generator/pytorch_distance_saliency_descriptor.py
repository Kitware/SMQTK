...
class DisMaskSaliencyDataset(data.Dataset):
    def __init__(self, masks, classifier, batch_size, sa_threshold=0.6, dis_type=DIS_TYPE.L2):
        """
...
class PytorchDisSaliencyDescriptorGenerator (DescriptorGenerator):
    ...
    def __init__(self, model_cls_name, model_uri=None, grid_size=20, stride=4,
        ...
        :param sa_threshold: the saliency map threshold defined as % of the max val
            of generated saliency map

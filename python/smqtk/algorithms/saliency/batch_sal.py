...
class Batch_SaliencyBlackbox (SaliencyBlackbox):
    ...
    def from_iqr_session(cls, iqrs, descr_gen, base_image): 
        ...
        return Batch_SaliencyBlackbox(ADJs, rel_index, descr_gen, base_image)
...
class Batch_ImageSaliencyAugmenter(ImageSaliencyAugmenter):
    """
...
SALIENCY_BLACKBOX_CLASS = Batch_SaliencyBlackbox
IMG_SALIENCY_AUGMENTER_CLASS = Batch_ImageSaliencyAugmenter

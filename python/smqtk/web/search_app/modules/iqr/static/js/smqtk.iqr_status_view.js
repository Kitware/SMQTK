...
IqrStatusView.prototype.update_pos_zone_content = function (iqr_sess_state) {
    ...
    for (var i=0; i < iqr_sess_state["external_pos"].length; i++) {
        new DataView(this.example_pos_data_zone, 0, iqr_sess_state["external_pos"][i],
                     0, false, true);
    }
};
...
IqrStatusView.prototype.update_neg_zone_content = function (iqr_sess_state) {
    ...
    for (var i=0; i < iqr_sess_state["external_neg"].length; i++) {
        new DataView(this.example_neg_data_zone, 0, iqr_sess_state["external_neg"][i],
                     0, false, true);
    }
};

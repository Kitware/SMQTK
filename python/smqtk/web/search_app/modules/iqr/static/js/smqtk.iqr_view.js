...
IqrView.prototype.construct_view = function (container) {
    ...
    this.button_state_save.text("Save IQR state").addClass('pull-right');
    this.button_state_load.text("Load IQR state").addClass('pull-right');
    ...
    this.flow_inst.onFileSuccess(function(file) {
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                alert_error("Error during file upload: "                          + jqXHR.responseText);
            }
        });
    });

...
TriageClipView.prototype.Init = function(container, kit_id, clip_id, score, kit_text, duration) {
    ...
    $(this.scorediv).html("<h3> #"+ rank +  ": "+ score.toFixed(2) + "</h3>");
    ...
    this.adjudication = new Adjudication({container : this.clipdiv, clip : this.clip_id});
    ...
    $(this.clipdiv).spriteOnHover({fps:4, rewind: "unanimate",repeat:true, loop : true});
    var that = this;
}
